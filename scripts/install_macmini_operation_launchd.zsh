...
/bin/cp "$SOURCE_ROOT/config/promo_budget_temporary.json" "$NODE_RUNTIME_ROOT/config/promo_budget_temporary.json"
...
# Retired permanently; also remove installations from older releases.
/bin/zsh "$SOURCE_ROOT/scripts/uninstall_daily_order_wechat_delivery.zsh"
...
echo "日配普通微信群投递已取消；下单、库存、表格及企业微信通知保持原流程。"
