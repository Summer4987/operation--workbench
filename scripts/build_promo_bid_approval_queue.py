...
def queue_item(item: dict[str, Any], index: int, decisions: dict[str, dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "approval_gate": {
            ...
            "can_enter_execution_plan": status == "approved",
            "message": "只有记录 approve 后，才会进入只读执行计划；本队列不提交平台。",
        },
...
def build_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "approval_gate": {
            ...
            "execution_plan_command": "python3 scripts/build_promo_bid_execution_plan.py",
        },
