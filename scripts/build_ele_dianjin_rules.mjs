...
writeTable(
  ...
  [
    ...
    ["饿了么", "晚餐", "17:30", "预算初始化", "是", "否", "17:30前完成所有门店预算调整；出价保持不变。"],
  ],
...
writeTable(
  ...
  stores.map(([name, , dinner]) => ["是", "饿了么", name, "17:30", dinner, "不变", "17:30前保证调整完成", ""]),
  [70, 90, 240, 90, 120, 120, 180, 220],
  {
    title: "晚餐 17:30 预算初始化",
    subtitle: "这一页只用于17:30预算调整，出价保持不变。",
    requiredCols: 6,
  }
);
...
writeTable(
  ...
  [
    ...
    ["17:30预算初始化", "不调整出价", "晚餐17:30只调整预算。", "是"],
  ],
  [160, 160, 520, 130],
  {
    title: "出价调整规则",
...
writeTable(
  ...
  [
    ...
    ["晚餐预算初始化", "17:30任务读取门店名称和晚餐预算，只修改预算。", "晚餐是否也需要后续消耗检查和调价。"],
