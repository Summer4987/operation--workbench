...
def test_total_balance_collection_includes_direct_meituan_and_validates_coverage():
    ...
    assert "run_isolated_collector" in text
    assert "Path(cdp_direct_meituan_balance.__file__)" in text
    assert '"--all"' in text
...
def test_meituan_balance_collection_includes_wangjing_and_knows_binjiang_id():
